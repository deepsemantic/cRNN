...
class ParameterInitializator:
    ...
    def cRNN_init_params(self, options, params, weight_filler, prefix='cRNN'):
        ...
        W_a = numpy.random.rand(1, options['attentive_residuals']).astype('float32')
...
class Layers:
    ...
    def cRNN_layer(self, tparams, x_in, h_0, c_0, options, prefix='cRNN'):
        ...
        def _cRNN_unit(x_, h_, c_, h_att):
            ...
            W_norm = tensor.nnet.softmax(tparams[_p(prefix, 'W_a')])
...
def build_model(tparams, options):
    ...
    h_1, c_1 = layer.cRNN_layer(tparams, emb, h1_init, c1_init, options, prefix='cRNN_1') 
    h_2, c_2 = layer.cRNN_layer(tparams, h_1, h2_init, c2_init, options, prefix='cRNN_2')  
...
def train_cRNN(
    ...
    init_state=True,
    init_lr_decay = 0.8,
    log_path='log/cRNN_wiki_softmax.log'
):
